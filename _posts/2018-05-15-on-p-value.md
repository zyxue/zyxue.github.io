...
class="false-negative">FN</span>) are colored differently.
  ...
  * Hovering a cell of interest will <span style="background-color:
    yellow">higlight</span> related cells, and you shall see the pattern of
    which metrics are related to which variables.
...
<script>
function higlight(srcSelector, tgtSelector) {
...
higlight('td.true-positive-rate', 'td.true-positive, td.condition-positive');
higlight('td.false-negative-rate', 'td.false-negative, td.condition-positive');
higlight('td.condition-positive', 'td.true-positive, td.false-negative');

higlight('td.false-positive-rate', 'td.false-positive, td.condition-negative');
higlight('td.true-negative-rate', 'td.true-negative, td.condition-negative');
higlight('td.condition-negative', 'td.false-positive, td.true-negative');

higlight('td.positive-predictive-rate', 'td.true-positive, td.predicted-positive');
higlight('td.false-discovery-rate', 'td.false-positive, td.predicted-positive');
higlight('td.predicted-positive', 'td.true-positive, td.false-positive');

higlight('td.false-omission-rate', 'td.false-negative, td.predicted-negative');
higlight('td.negative-predictive-rate', 'td.true-negative, td.predicted-negative');
higlight('td.predicted-negative', 'td.false-negative, td.true-negative');



higlight('td.true-positive', 'td.condition-positive, td.true-positive-rate, td.predicted-positive, td.positive-predictive-rate');
higlight('td.false-negative', 'td.condition-positive, td.false-negative-rate, td.predicted-negative, td.false-omission-rate');
higlight('td.false-positive', 'td.condition-negative, td.false-positive-rate, td.predicted-positive, td.false-discovery-rate');
higlight('td.true-negative', 'td.condition-negative, td.true-negative-rate, td.predicted-negative, td.negative-predictive-rate');
